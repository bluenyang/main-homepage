...
<template>
  ...
  >
    ...
    <div class="z-20 mb-4 flex w-full flex-col gap-4 font-[Jua] sm:flex-row lg:flex-row">
      ...
      <div class="flex h-full flex-1 flex-row items-center justify-evenly">
        ...
        >
          <Icon
            icon="mdi:github"
            class="size-8 text-black transition-all duration-500 hover:-translate-y-1 hover:text-sky-300 dark:text-white dark:hover:text-sky-400"
          />
        </a>
        <a
