...
<template>
  ...
  >
    ...
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      class="absolute -rotate-30 text-black transition-all duration-500 ease-in-out dark:scale-0 dark:-rotate-120 dark:opacity-0"
    >
      <path
    ...
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      class="absolute scale-0 text-white opacity-0 transition-all duration-500 ease-in-out dark:scale-100 dark:-rotate-90 dark:opacity-100"
    >
      <path
